...
**Phase 9 candidate generation complete to first-pass depth. No final architecture selections have been accepted.**
...
|---|---|---|---|---|---|---|---|
| DL-001 | control organization | hierarchical allocation / distributed local control / integrated implicit control / developmental organization | unresolved | cross-domain allocation synthesis | one global executive is required; decentralization is inherently superior | open | E01 + E22 |
| DL-002 | cognitive integration | explicit heterogeneous processes / tightly integrated shared core / emergent structural mixture | unresolved | architecture/systems + functional contracts | more modules means more intelligence; one block can do everything best | open | E02 |
...
| DL-004 | internal reasoning/communication representation | human-readable discrete / continuous machine-native / structured-executable / hybrid | unresolved | focused representation pass | human language or any one latent form is universal | open | E04 |
